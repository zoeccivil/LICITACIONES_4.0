# ui/themes/professional_light_theme.py
from __future__ import annotations
from PyQt6.QtWidgets import QApplication
from PyQt6.QtGui import QPalette, QColor
from PyQt6.QtCore import Qt

def apply_professional_light_theme(app: QApplication) -> None:
    """
    Aplica un tema claro, limpio y profesional con acentos azules.
    """
    app.setStyle("Fusion")
    ...
    COLOR_LINK = QColor(0, 102, 204)        # Links
    ...
    pal.setColor(QPalette.ColorRole.BrightText, Qt.GlobalColor.white) # Usado para texto "brillante" sobre colores oscuros
    ...
    app.setStyleSheet(f"""
        ...
        QTabBar::tab {{
            background: {COLOR_WINDOW.name()}; /* Fondo de la app */
            border: 1px solid {COLOR_BORDER.name()};
            border-bottom: none;
            padding: 6px 10px;
            margin-right: 2px;
