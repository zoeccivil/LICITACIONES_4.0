# ui/themes/graphite_theme.py
from __future__ import annotations
from PyQt6.QtWidgets import QApplication
from PyQt6.QtGui import QPalette, QColor
from PyQt6.QtCore import Qt

def apply_graphite_theme(app: QApplication) -> None:
    """
    Aplica un tema "Grafito" (oscuro) con acentos ámbar/naranja.
    """
    app.setStyle("Fusion")
    ...
    COLOR_BASE = QColor(33, 33, 33)         # Fondo de inputs (#212121)
    COLOR_WINDOW = QColor(48, 48, 48)       # Fondo principal (#303030)
    COLOR_ALT_BASE = QColor(38, 38, 38)     # Filas alternas
    COLOR_BORDER = QColor(66, 66, 66)       # Bordes (#424242)

    # --- Colores de Texto ---
    COLOR_TEXT = QColor(224, 224, 224)      # Texto principal (#E0E0E0)
    COLOR_DISABLED_TEXT = QColor(117, 117, 117) # Texto deshabilitado (#757575)

    # --- Colores de Acento (Naranja/Ámbar) ---
    COLOR_HIGHLIGHT = QColor(230, 126, 34)  # Naranja (#e67e22)
    COLOR_HIGHLIGHT_TEXT = QColor(255, 255, 255)
    COLOR_LINK = QColor(243, 156, 18)       # Ámbar (#f39c12)
